public class Ekspedisi{
    ...
    public void informasi(){
        System.out.println("Ekspedisi tidak diketahui dengan jumlah cabang " + this.jumlahCabang + " dan berpusat di " + this.pusat + " mempunyai tarif sebesar " + this.tarif + " perkilogram");
    }
}
