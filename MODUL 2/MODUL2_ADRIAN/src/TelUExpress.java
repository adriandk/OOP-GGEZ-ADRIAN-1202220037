public class TelUExpress extends Ekspedisi {
    ...
    public void informasi(){
        System.out.println("Ekspedisi TelUExpress dengan jumlah cabang " + this.jumlahCabang + " dan berpusat di " + this.pusat + " mempunyai tarif sebesar " + this.tarif + " perkilogram");
        System.out.print("Selain itu, ");
        if (antarInter){
            System.out.println("Ekspedisi ini melayani pengantaran international");
        } else {
